...
func TestGenerateRandomStrategy(t *testing.T) {
	...
	tests := []struct {
		...
		{"ok", args{4, []Strategy{StrategyMutateTerminal, StrategyAddSubTree}}, []Strategy{StrategyMutateTerminal,
			StrategyAddSubTree, StrategyMutateTerminal, StrategyAddSubTree}},
	}
...
//		//
//		//{"params Strategy length crossover% = 0.5", args{
//		//	individual:Individual{Id: GenerateProgramID(0), Strategy: []Strategy{StrategyAddSubTree, StrategyDeleteTerminal},
...
func TestStrategySwapper(t *testing.T) {
	...
	tests := []struct {
		...
		{"a2 : b2 : sl=1 : si=0", args{
			a:          []Strategy{StrategyReplaceBranch, StrategyDeleteMalicious},
			b:          []Strategy{StrategyDeleteTerminal, StrategyAddSubTree},
			swapLength: 1,
			startIndex: 0},
			[]Strategy{StrategyDeleteTerminal, StrategyDeleteMalicious},
			[]Strategy{StrategyReplaceBranch, StrategyAddSubTree},
		},
		...
		{"a3 : b2 : sl=2 : si=5", args{
			...
			swapLength: 2,
			startIndex: 5},
			[]Strategy{StrategyDeleteTerminal, StrategyAddSubTree, StrategyMutateNonTerminal},
			[]Strategy{StrategyReplaceBranch, StrategyDeleteMalicious},
		},
