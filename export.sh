...
#scp -i ~/.ssh/id_rsa -r _shippNow   martin.omburajr@35.188.247.90:~/trial0/ &
#
#scp -i ~/.ssh/id_rsa masters   martin.omburajr@35.203.187.69:~/trial0/masters2 &
...
###
#scp -i ~/.ssh/id_rsa masters   martin.omburajr@35.231.221.212:~/trial0/masters2 &
...
##
#scp -i ~/.ssh/id_rsa masters   martin.omburajr@35.195.41.51:~/trial0/masters2 &
...
scp -i ~/.ssh/id_rsa -r _pshipped_params/TopologyRoundRobin-41   martin.omburajr@35.195.41.51:~/trial0/_params &
wait
